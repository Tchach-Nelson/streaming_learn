...
exports.ParticipationModule = ParticipationModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([participation_entity_1.Participation, participation_service_1.ParticipationService])],
        controllers: [participation_controller_1.ParticipationController],
        providers: [participation_service_1.ParticipationService],
        exports: [typeorm_1.TypeOrmModule, participation_service_1.ParticipationService],
    })
], ParticipationModule);
